...
/*
function bbps_admin_setting_callback_color_change(){
?>
	<input id="bbps_status_color_change" name="_bbps_status_color_change" <?php checked( bbps_is_color_change_enabled(),1 ); ?> type="checkbox"  value="1" />
	<label for="bbps_status_permissions"><?php _e( 'Resolved Topics will have a green topic title to reflect that they are resolved.', 'bbpress' ); ?></label>
<?php
...
/*  checked( bbps_is_post_count_enabled() ); */ ?>
